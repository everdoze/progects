...
DDEESSCCRRIIPPTTIIOONN
       ...
       Multiple lines can be added to an option by using the _-_-_a_d_d option. If you want to update or unset an
       option which can occur on multiple lines, a POSIX regexp value_regex needs to be given. Only the
       existing values that match the regexp are updated or unset. If you want to handle the lines that do nnoott
       match the regex, just prepend a single exclamation mark in front (see also the section called
       “EXAMPLES”).

       The type specifier can be either _-_-_i_n_t or _-_-_b_o_o_l, to make _g_i_t _c_o_n_f_i_g ensure that the variable(s) are of
       the given type and convert the value to the canonical form (simple decimal number for int, a "true" or
       "false" string for bool), or _-_-_p_a_t_h, which does some path expansion (see _-_-_p_a_t_h below). If no type
       ...
       default, and options _-_-_s_y_s_t_e_m, _-_-_g_l_o_b_a_l, _-_-_l_o_c_a_l and _-_-_f_i_l_e _<_f_i_l_e_n_a_m_e_> can be used to tell the command
       ...
       options _-_-_s_y_s_t_e_m, _-_-_g_l_o_b_a_l, _-_-_f_i_l_e _<_f_i_l_e_n_a_m_e_> can be used to tell the command to write to that location
...
OOPPTTIIOONNSS
       ...
       --add
           ...
           _^_$ as the value_regex in --replace-all.
       ...
       --get-regexp
           ...
           Regular expression matching is currently case-sensitive and done against a canonicalized version of
       ...
       --get-urlmatch name URL
           ...
           the best to the given URL is returned (if no such key exists, the value for section.key is used as
           a fallback). When given just the section as name, do so for all the keys in the section and list
           them.
       ...
       --blob blob
           Similar to _-_-_f_i_l_e but use the given blob instead of a file. E.g. you can use _m_a_s_t_e_r_:_._g_i_t_m_o_d_u_l_e_s to
           read values from the file _._g_i_t_m_o_d_u_l_e_s in the master branch. See "SPECIFYING REVISIONS" section in
       ...
       --int
           _g_i_t _c_o_n_f_i_g will ensure that the output is a simple decimal number. An optional value suffix of _k,
           _m, or _g in the config file will cause the value to be multiplied by 1024, 1048576, or 1073741824
           prior to output.

       --bool-or-int
           _g_i_t _c_o_n_f_i_g will ensure that the output matches the format of either --bool or --int, as described
           above.

       --path
           _g_i_t_-_c_o_n_f_i_g will expand leading _~ to the value of _$_H_O_M_E, and _~_u_s_e_r to the home directory for the
           specified user. This option has no effect when setting the value (but you can use _g_i_t _c_o_n_f_i_g _b_l_a _~_/
           from the command line to let your shell do the expansion).

       -z, --null
           For all options that output values and/or keys, always end values with the null character (instead
           of a newline). Use newline instead as a delimiter between key and value. This allows for secure
       ...
       --get-colorbool name [stdout-is-tty]
           ...
           status 0 if color is to be used, or exits with status 1 otherwise. When the color setting for name
       ...
       -e, --edit
           Opens an editor to modify the specified config file; either _-_-_s_y_s_t_e_m, _-_-_g_l_o_b_a_l, or repository
           (default).
...
FFIILLEESS
       ...
       repository configuration file is not available or readable, _g_i_t _c_o_n_f_i_g will exit with a non-zero error
       ...
       this also affects options like _-_-_r_e_p_l_a_c_e_-_a_l_l and _-_-_u_n_s_e_t. _g_i_t _c_o_n_f_i_g wwiillll oonnllyy eevveerr cchhaannggee oonnee ffiillee aatt
       aa ttiimmee.

       You can override these rules either by command-line options or by environment variables. The _-_-_g_l_o_b_a_l
       and the _-_-_s_y_s_t_e_m options will limit the file used to the global or system-wide file respectively. The
...
EEXXAAMMPPLLEESS
       ...
       The hypothetical proxy command entries actually have a postfix to discern what URL they apply to. Here
...
CCOONNFFIIGGUURRAATTIIOONN FFIILLEE
   ...
   SSyynnttaaxx
       The syntax is fairly flexible and permissive; whitespaces are mostly ignored. The _# and _; characters
       ...
       variables, in the form _n_a_m_e _= _v_a_l_u_e. If there is no equal sign on the line, the entire line is taken as
       _n_a_m_e and the variable is recognized as boolean "true". The variable names are case-insensitive, allow
       ...
       boolean values, when converting value to the canonical form using _-_-_b_o_o_l type specifier; _g_i_t _c_o_n_f_i_g
       ...
       value contains comment characters (i.e. it contains _# or _;). Double quote " and backslash \ characters
       in variable values must be escaped: use \" for " and \\ for \.
   ...
   IInncclluuddeess
       ...
       found at the location of the include directive. If the value of the include.path variable is a relative
       path, the path is considered to be relative to the configuration file in which the include directive
       was found. The value of include.path is subject to tilde expansion: ~/ is expanded to the value of
       $HOME, and ~user/ to the specified user’s home directory. See below for examples.
   ...
   VVaarriiaabblleess
       ...
       Other git-related tools may and do use their own variables. When inventing new variables for use in
       your own tool, make sure their names do not conflict with those that are used by Git itself and other
       popular tools, and describe them in your documentation.

       advice.*
           These variables control various optional help messages designed to aid new users. All _a_d_v_i_c_e_._*
           variables default to _t_r_u_e, and you can tell Git that you do not need help by setting these to
           _f_a_l_s_e:
           ...
           pushNonFFMatching
               ...
               specified a refspec that isn’t your current branch) and it resulted in a non-fast-forward
               error.

           pushAlreadyExists
               Shown when ggiitt--ppuusshh(1) rejects an update that does not qualify for fast-forwarding (e.g., a
               tag.)

           pushFetchFirst
               Shown when ggiitt--ppuusshh(1) rejects an update that tries to overwrite a remote ref that points at an
           ...
           statusHints
               ...
               template shown when writing commit messages in ggiitt--ccoommmmiitt(1), and in the help message shown by
               ggiitt--cchheecckkoouutt(1) when switching branch.

           statusUoption
               Advise to consider using the -u option to ggiitt--ssttaattuuss(1) when the command takes more than 2
           ...
           detachedHead
               Advice shown when you used ggiitt--cchheecckkoouutt(1) to move to the detach HEAD state, to instruct how to
           ...
           rmHints
               In case of failure in the output of ggiitt--rrmm(1), show directions on how to proceed from the
               current state.

       core.fileMode
           If false, the executable bit differences between the index and the working tree are ignored; useful
           on broken filesystems like FAT. See ggiitt--uuppddaattee--iinnddeexx(1).
       ...
       core.checkstat
           ...
           _d_e_f_a_u_l_t or _m_i_n_i_m_a_l. Default (or explicitly _d_e_f_a_u_l_t), is to check all fields, including the
           sub-second part of mtime and ctime.

       core.quotepath
           The commands that output paths (e.g.  _l_s_-_f_i_l_e_s, _d_i_f_f), when not given the -z option, will quote
       ...
       core.eol
           ...
           set. Alternatives are _l_f, _c_r_l_f and _n_a_t_i_v_e, which uses the platform’s native line ending. The
           default value is native. See ggiittaattttrriibbuutteess(5) for more information on end-of-line conversion.
       ...
       core.safecrlf
           ...
           example, committing a file followed by checking out the same file should yield the original file in
           the work tree. If this is not the case for the current setting of core.autocrlf, Git will reject
           the file. The variable can be set to "warn", in which case Git will only warn about an irreversible
           ...
           corrects line endings such that we have only LF line endings in the repository. But for binary
           ...
           tree and this file is not yet corrupted. You can explicitly tell Git that this file is binary and
           ...
           removed in an irreversible way. For text files this is the right thing to do because CRLFs are line
           ...
           original file for a different setting of core.eol and core.autocrlf, but only for the current one.
           For example, a text file with LF would be accepted with core.eol=lf and could later be checked out
           with core.eol=crlf, in which case the resulting file would contain CRLF, although the original file
           contained LF. However, in both work trees the line endings would be consistent, that is either all
           LF or all CRLF, but never mixed. A file with mixed line endings would be reported by the
       ...
       core.autocrlf
           ...
           can be set to _i_n_p_u_t, in which case no output conversion is performed.

       core.symlinks
           If false, symbolic links are checked out as small plain files that contain the link text.  ggiitt--
           uuppddaattee--iinnddeexx(1) and ggiitt--aadddd(1) will not change the recorded type to regular file. Useful on
       ...
       core.gitProxy
           A "proxy command" to execute (as _c_o_m_m_a_n_d _h_o_s_t _p_o_r_t) instead of establishing direct connection to
           ...
           Can be overridden by the _G_I_T___P_R_O_X_Y___C_O_M_M_A_N_D environment variable (which always applies universally,
       ...
       core.ignoreStat
           If true, commands which modify both the working tree and the index will mark the updated paths with
           the "assume unchanged" bit in the index. These marked files are then assumed to stay unchanged in
           the working tree, until you mark them otherwise manually - Git will not detect the file changes by
           lstat() calls. This is useful on systems where those are very slow, such as Microsoft Windows. See
           ggiitt--uuppddaattee--iinnddeexx(1). False by default.
       ...
       core.bare
           If true this repository is assumed to be _b_a_r_e and has no working directory associated with it. If
           ...
           This setting is automatically guessed by ggiitt--cclloonnee(1) or ggiitt--iinniitt(1) when the repository was
       ...
       core.worktree
           ...
           environment variable and the _-_-_w_o_r_k_-_t_r_e_e command-line option. The value can be an absolute path or
           relative to the path to the .git directory, which is either specified by --git-dir or GIT_DIR, or
           automatically discovered. If --git-dir or GIT_DIR is specified but none of --work-tree,
           GIT_WORK_TREE and core.worktree is specified, the current working directory is regarded as the top
       ...
       core.logAllRefUpdates
           ...
           the new and old SHA-1, the date/time and the reason of the update, but only when the file exists.
           If this configuration variable is set to true, missing "$GIT_DIR/logs/<ref>" file is automatically
           created for branch heads (i.e. under refs/heads/), remote refs (i.e. under refs/remotes/), note
       ...
       core.sharedRepository
           When _g_r_o_u_p (or _t_r_u_e), the repository is made shareable between several users in a group (making
           sure all the files and objects are group-writable). When _a_l_l (or _w_o_r_l_d or _e_v_e_r_y_b_o_d_y), the
           repository will be readable by all users, additionally to being group-shareable. When _u_m_a_s_k (or
           _f_a_l_s_e), Git will use permissions reported by umask(2). When _0_x_x_x, where _0_x_x_x is an octal number,
           files in the repository will have this mode value.  _0_x_x_x will override user’s umask value (whereas
           the other options will only override requested parts of the user’s umask value). Examples: _0_6_6_0
           will make the repo read/write-able for the owner and group, but inaccessible to others (equivalent
           to _g_r_o_u_p unless umask is e.g.  _0_0_2_2).  _0_6_4_0 is a repository that is group-readable but not
       ...
       core.compression
           ...
           default to other compression variables, such as _c_o_r_e_._l_o_o_s_e_c_o_m_p_r_e_s_s_i_o_n and _p_a_c_k_._c_o_m_p_r_e_s_s_i_o_n.
       ...
       core.packedGitLimit
           ...
           all users/operating systems, except on the largest projects. You probably do not need to adjust
           this value.
       ...
       core.deltaBaseCacheLimit
           ...
           Default is 96 MiB on all platforms. This should be reasonable for all users/operating systems,
       ...
       core.excludesfile
           In addition to _._g_i_t_i_g_n_o_r_e (per-directory) and _._g_i_t_/_i_n_f_o_/_e_x_c_l_u_d_e, Git looks into this file for
           patterns of files which are not meant to be tracked. "~/" is expanded to the value of $HOME and
           "~user/" to the specified user’s home directory. Its default value is $XDG_CONFIG_HOME/git/ignore.
           If $XDG_CONFIG_HOME is either not set or empty, $HOME/.config/git/ignore is used instead. See
       ...
       core.askpass
           ...
           use an external program given via the value of this variable. Can be overridden by the _G_I_T___A_S_K_P_A_S_S
           environment variable. If not set, fall back to the value of the _S_S_H___A_S_K_P_A_S_S environment variable
           or, failing that, a simple password prompt. The external program shall be given a suitable prompt
           as command-line argument and write the password on its STDOUT.

       core.attributesfile
           In addition to _._g_i_t_a_t_t_r_i_b_u_t_e_s (per-directory) and _._g_i_t_/_i_n_f_o_/_a_t_t_r_i_b_u_t_e_s, Git looks into this file
           for attributes (see ggiittaattttrriibbuutteess(5)). Path expansions are made the same way as for
       ...
       core.editor
           ...
           of this variable when it is set, and the environment variable GIT_EDITOR is not set. See ggiitt--
           vvaarr(1).
       ...
       core.commentchar
           ...
           If set to "auto", git-commit would select a character that is not the beginning character of any
           line in existing commit messages.

       sequence.editor
           Text editor used by git rebase -i for editing the rebase instruction file. The value is meant to be
           interpreted by the shell when it is used. It can be overridden by the GIT_SEQUENCE_EDITOR
           environment variable. When not configured the default commit message editor is used instead.

       core.pager
           Text viewer for use by Git commands (e.g., _l_e_s_s). The value is meant to be interpreted by the
           shell. The order of preference is the $GIT_PAGER environment variable, then core.pager
           configuration, then $PAGER, and then the default chosen at compile time (usually _l_e_s_s).

           When the LESS environment variable is unset, Git sets it to FRX (if LESS environment variable is
           set, Git does not change it at all). If you want to selectively override Git’s default setting for
           LESS, you can set core.pager to e.g.  less -S. This will be passed to the shell by Git, which will
           translate the final command to LESS=FRX less -S. The environment does not set the S option but the
           command line does, instructing less to truncate long lines. Similarly, setting core.pager to less
           -+F will deactivate the F option specified by the environment from the command-line, deactivating
           the "quit if one screen" behavior of less. One can specifically activate some flags for particular
           commands: for example, setting pager.blame to less -S enables line truncation only for git blame.

           Likewise, when the LV environment variable is unset, Git sets it to -c. You can override this
           setting by exporting LV with another value or setting core.pager to lv +c.

       core.whitespace
           A comma separated list of common whitespace problems to notice.  _g_i_t _d_i_f_f will use
           color.diff.whitespace to highlight them, and _g_i_t _a_p_p_l_y _-_-_w_h_i_t_e_s_p_a_c_e_=_e_r_r_o_r will consider them as
       ...
       core.fsyncobjectfiles
           ...
           This is a total waste of time and effort on a filesystem that orders data writes properly, but can
           be useful for filesystems that do not use journalling (traditional UNIX filesystems) or that only
       ...
       core.preloadindex
           ...
           This can speed up operations like _g_i_t _d_i_f_f and _g_i_t _s_t_a_t_u_s especially on filesystems like NFS that
       ...
       core.createObject
           You can set this to _l_i_n_k, in which case a hardlink followed by a delete of the source are used to
           ...
           _r_e_n_a_m_e there; However, This will remove the check that makes sure that existing object files will
           not get overwritten.
       ...
       core.notesRef
           ...
           This setting defaults to "refs/notes/commits", and it can be overridden by the _G_I_T___N_O_T_E_S___R_E_F
           environment variable. See ggiitt--nnootteess(1).

       core.sparseCheckout
           Enable "sparse checkout" feature. See section "Sparse checkout" in ggiitt--rreeaadd--ttrreeee(1) for more
           information.
       ...
       add.ignore-errors, add.ignoreErrors
           Tells _g_i_t _a_d_d to continue adding files when some files cannot be added due to indexing errors.
           Equivalent to the _-_-_i_g_n_o_r_e_-_e_r_r_o_r_s option of ggiitt--aadddd(1). Older versions of Git accept only
       ...
       alias.*
           Command aliases for the ggiitt(1) command wrapper - e.g. after defining "alias.last = cat-file commit
           HEAD", the invocation "git last" is equivalent to "git cat-file commit HEAD". To avoid confusion
           and troubles with script usage, aliases that hide existing Git commands are ignored. Arguments are
           split by spaces, the usual shell quoting and escaping is supported. quote pair and a backslash can
           be used to quote them.

           If the alias expansion is prefixed with an exclamation point, it will be treated as a shell
           command. For example, defining "alias.new = !gitk --all --not ORIG_HEAD", the invocation "git new"
           is equivalent to running the shell command "gitk --all --not ORIG_HEAD". Note that shell commands
           will be executed from the top-level directory of a repository, which may not necessarily be the
           current directory.  _G_I_T___P_R_E_F_I_X is set as returned by running _g_i_t _r_e_v_-_p_a_r_s_e _-_-_s_h_o_w_-_p_r_e_f_i_x from the
           original current directory. See ggiitt--rreevv--ppaarrssee(1).

       am.keepcr
           If true, git-am will call git-mailsplit for patches in mbox format with parameter _-_-_k_e_e_p_-_c_r. In
           this case git-mailsplit will not remove \r from lines ending with \r\n. Can be overridden by giving
           _-_-_n_o_-_k_e_e_p_-_c_r from the command line. See ggiitt--aamm(1), ggiitt--mmaaiillsspplliitt(1).
       ...
       apply.ignorewhitespace
           ...
           _-_-_i_g_n_o_r_e_-_s_p_a_c_e_-_c_h_a_n_g_e option. When set to one of: no, none, never, false tells _g_i_t _a_p_p_l_y to respect
           all whitespace differences. See ggiitt--aappppllyy(1).

       apply.whitespace
           Tells _g_i_t _a_p_p_l_y how to handle whitespaces, in the same way as the _-_-_w_h_i_t_e_s_p_a_c_e option. See ggiitt--
           aappppllyy(1).

       branch.autosetupmerge
           Tells _g_i_t _b_r_a_n_c_h and _g_i_t _c_h_e_c_k_o_u_t to set up new branches so that ggiitt--ppuullll(1) will appropriately
           merge from the starting point branch. Note that even if this option is not set, this behavior can
           be chosen per-branch using the --track and --no-track options. The valid settings are: false — no
           automatic setup is done; true — automatic setup is done when the starting point is a
       ...
       branch.autosetuprebase
           When a new branch is created with _g_i_t _b_r_a_n_c_h or _g_i_t _c_h_e_c_k_o_u_t that tracks another branch, this
       ...
       branch.<name>.remote
           When on branch <name>, it tells _g_i_t _f_e_t_c_h and _g_i_t _p_u_s_h which remote to fetch from/push to. The
       ...
       branch.<name>.merge
           ...
           _f_e_t_c_h/_g_i_t _p_u_l_l/_g_i_t _r_e_b_a_s_e which branch to merge and can also affect _g_i_t _p_u_s_h (see push.default).
           When in branch <name>, it tells _g_i_t _f_e_t_c_h the default refspec to be marked for merging in
           FETCH_HEAD. The value is handled like the remote part of a refspec, and must match a ref which is
           fetched from the remote given by "branch.<name>.remote". The merge information is used by _g_i_t _p_u_l_l
           (which at first calls _g_i_t _f_e_t_c_h) to lookup the default branch for merging. Without this option, _g_i_t
           _p_u_l_l defaults to merge the first refspec fetched. Specify multiple values to get an octopus merge.
           If you wish to setup _g_i_t _p_u_l_l so that it merges into <name> from another branch in the local
           repository, you can point branch.<name>.merge to the desired branch, and use the relative path
           setting .  (a period) for branch.<name>.remote.

       branch.<name>.mergeoptions
           Sets default options for merging into branch <name>. The syntax and supported options are the same
           as those of ggiitt--mmeerrggee(1), but option values containing whitespace characters are currently not
           supported.
       ...
       branch.<name>.rebase
           ...
           NNOOTTEE: this is a possibly dangerous operation; do nnoott use it unless you understand the implications
       ...
       browser.<tool>.cmd
           ...
           with the URLs passed as arguments. (See ggiitt--wweebb----bbrroowwssee(1).)

       browser.<tool>.path
           Override the path for the given tool that may be used to browse HTML help (see _-_w option in ggiitt--
           hheellpp(1)) or a working repository in gitweb (see ggiitt--iinnssttaawweebb(1)).

       clean.requireForce
           A boolean to make git-clean do nothing unless given -f, -i or -n. Defaults to true.

       color.branch
           A boolean to enable/disable color in the output of ggiitt--bbrraanncchh(1). May be set to always, false (or
       ...
       color.diff
           Whether to use ANSI escape sequences to add color to patches. If this is set to always, ggiitt--
           ddiiffff(1), ggiitt--lloogg(1), and ggiitt--sshhooww(1) will use color for all patches. If it is set to true or auto,
           those commands will only use color when output is to the terminal. Defaults to false.

           This does not affect ggiitt--ffoorrmmaatt--ppaattcchh(1) or the _g_i_t_-_d_i_f_f_-_* plumbing commands. Can be overridden on
       ...
       color.diff.<slot>
           ...
           _f_u_n_c (function in hunk header), old (removed lines), new (added lines), commit (commit headers), or
           whitespace (highlighting whitespace errors). The values of these variables may be specified as in
           color.branch.<slot>.

       color.decorate.<slot>
           Use customized color for _g_i_t _l_o_g _-_-_d_e_c_o_r_a_t_e output.  <slot> is one of branch, remoteBranch, tag,
       ...
       color.interactive.<slot>
           Use customized color for _g_i_t _a_d_d _-_-_i_n_t_e_r_a_c_t_i_v_e and _g_i_t _c_l_e_a_n _-_-_i_n_t_e_r_a_c_t_i_v_e output.  <slot> may be
       ...
       color.showbranch
           A boolean to enable/disable color in the output of ggiitt--sshhooww--bbrraanncchh(1). May be set to always, false
           (or never) or auto (or true), in which case colors are used only when the output is to a terminal.
           Defaults to false.

       color.status
           A boolean to enable/disable color in the output of ggiitt--ssttaattuuss(1). May be set to always, false (or
           never) or auto (or true), in which case colors are used only when the output is to a terminal.
           Defaults to false.
       ...
       color.status.<slot>
           ...
           (the current branch), or nobranch (the color the _n_o _b_r_a_n_c_h warning is shown in, defaulting to red).
           The values of these variables may be specified as in color.branch.<slot>.
       ...
       color.ui
           ...
           option. Set it to always if you want all output not intended for machine consumption to use color,
           to true or auto (this is the default since Git 1.8.4) if you want such output to use color when
       ...
       column.ui
           ...
           These options control layout (defaults to _c_o_l_u_m_n). Setting any of these implies _a_l_w_a_y_s if none of
       ...
       commit.cleanup
           This setting overrides the default of the --cleanup option in git commit. See ggiitt--ccoommmmiitt(1) for
       ...
       credential.helper
           ...
           ggiittccrreeddeennttiiaallss(7) for details.
       ...
       credential.<url>.*
           ...
           to example.com. See ggiittccrreeddeennttiiaallss(7) for details on how URLs are matched.

       diff.autorefreshindex
           When using _g_i_t _d_i_f_f to compare with work tree files, do not consider stat-only change as changed.
           ...
           that this affects only _g_i_t _d_i_f_f Porcelain, and not lower level _d_i_f_f commands such as _g_i_t
           _d_i_f_f_-_f_i_l_e_s.

       diff.dirstat
           A comma separated list of --dirstat parameters specifying the default behavior of the --dirstat
           option to ggiitt--ddiiffff(1)` and friends. The defaults can be overridden on the command line (using
       ...
       diff.external
           ...
           but using the given command. Can be overridden with the ‘GIT_EXTERNAL_DIFF’ environment variable.
           The command is called with parameters as described under "git Diffs" in ggiitt(1). Note: if you want
           to use an external diff program only on a subset of your files, you might want to use
           ggiittaattttrriibbuutteess(5) instead.

       diff.ignoreSubmodules
           Sets the default value of --ignore-submodules. Note that this affects only _g_i_t _d_i_f_f Porcelain, and
           not lower level _d_i_f_f commands such as _g_i_t _d_i_f_f_-_f_i_l_e_s.  _g_i_t _c_h_e_c_k_o_u_t also honors this setting when
           reporting uncommitted changes. Setting it to _a_l_l disables the submodule summary normally shown by
           _g_i_t _c_o_m_m_i_t and _g_i_t _s_t_a_t_u_s when _s_t_a_t_u_s_._s_u_b_m_o_d_u_l_e_s_u_m_m_a_r_y is set unless it is overridden by using the
           --ignore-submodules command-line option. The _g_i_t _s_u_b_m_o_d_u_l_e commands are not affected by this
           setting.

       diff.mnemonicprefix
           If set, _g_i_t _d_i_f_f uses a prefix pair that is different from the standard "a/" and "b/" depending on
       ...
       diff.orderfile
           ...
           overridden by the _-_O option to ggiitt--ddiiffff(1).

       diff.renameLimit
           The number of files to consider when performing the copy/rename detection; equivalent to the _g_i_t
           _d_i_f_f option _-_l.
       ...
       diff.submodule
           ...
           in the range like ggiitt--ssuubbmmoodduullee(1)summary does. The "short" format format just shows the names of
       ...
       diff.wordRegex
           ...
           difference calculations. Character sequences that match the regular expression are "words", all
           other characters are iiggnnoorraabbllee whitespace.
       ...
       diff.<driver>.xfuncname
           ...
           pattern may also be used. See ggiittaattttrriibbuutteess(5) for details.

       diff.<driver>.binary
           Set this option to true to make the diff driver treat files as binary. See ggiittaattttrriibbuutteess(5) for
           details.

       diff.<driver>.textconv
           The command that the diff driver should call to generate the text-converted version of a file. The
           result of the conversion is used to generate a human-readable diff. See ggiittaattttrriibbuutteess(5) for
           details.
       ...
       diff.tool
           Controls which diff tool is used by ggiitt--ddiiffffttooooll(1). This variable overrides the value configured
       ...
       difftool.<tool>.cmd
           ...
           with the following variables available: _L_O_C_A_L is set to the name of the temporary file containing
           the contents of the diff pre-image and _R_E_M_O_T_E is set to the name of the temporary file containing
       ...
       fetch.recurseSubmodules
           This option can be either set to a boolean value or to _o_n_-_d_e_m_a_n_d. Setting it to a boolean changes
           the behavior of fetch and pull to unconditionally recurse into submodules when set to true or to
           not recurse at all when set to false. When set to _o_n_-_d_e_m_a_n_d (the default value), fetch and pull
       ...
       fetch.unpackLimit
           ...
           will be unpacked into loose object files. However if the number of received objects equals or
           exceeds this limit then the received pack will be stored as a pack, after adding any missing delta
           bases. Storing the pack from a push can make the push operation complete faster, especially on slow
       ...
       format.attach
           Enable multipart/mixed attachments as the default for _f_o_r_m_a_t_-_p_a_t_c_h. The value can also be a double
           quoted string which will enable attachments as the default and set the value as the boundary. See
       ...
       format.numbered
           ...
           messages by setting it to "true" or "false". See --numbered option in ggiitt--ffoorrmmaatt--ppaattcchh(1).
       ...
       format.to, format.cc
           ...
           in ggiitt--ffoorrmmaatt--ppaattcchh(1).

       format.subjectprefix
           The default for format-patch is to output files with the _[_P_A_T_C_H_] subject prefix. Use this variable
       ...
       format.thread
           The default threading style for _g_i_t _f_o_r_m_a_t_-_p_a_t_c_h. Can be a boolean value, or shallow or deep.
       ...
       format.signoff
           A boolean value which lets you enable the -s/--signoff option of format-patch by default.  NNoottee::
       ...
       gc.aggressiveDepth
           The depth parameter used in the delta compression algorithm used by _g_i_t _g_c _-_-_a_g_g_r_e_s_s_i_v_e. This
           defaults to 250.
       ...
       gc.autodetach
           Make git gc --auto return immediately andrun in background if the system supports it. Default is
           true.

       gc.packrefs
           Running git pack-refs in a repository renders it unclonable by Git versions prior to 1.5.1.2 over
           dumb transports such as HTTP. This variable determines whether _g_i_t _g_c runs git pack-refs. This can
           be set to notbare to enable it within all non-bare repos or it can be set to a boolean value. The
           default is true.

       gc.pruneexpire
           When _g_i_t _g_c is run, it will call _p_r_u_n_e _-_-_e_x_p_i_r_e _2_._w_e_e_k_s_._a_g_o. Override the grace period with this
           config variable. The value "now" may be used to disable this grace period and always prune
           unreachable objects immediately.

       gc.reflogexpire, gc.<pattern>.reflogexpire
           _g_i_t _r_e_f_l_o_g _e_x_p_i_r_e removes reflog entries older than this time; defaults to 90 days. With
       ...
       gc.reflogexpireunreachable, gc.<ref>.reflogexpireunreachable
           _g_i_t _r_e_f_l_o_g _e_x_p_i_r_e removes reflog entries older than this time and are not reachable from the
       ...
       gc.rerereresolved
           Records of conflicted merge you resolved earlier are kept for this many days when _g_i_t _r_e_r_e_r_e _g_c is
           run. The default is 60 days. See ggiitt--rreerreerree(1).

       gc.rerereunresolved
           Records of conflicted merge you have not resolved are kept for this many days when _g_i_t _r_e_r_e_r_e _g_c is
           run. The default is 15 days. See ggiitt--rreerreerree(1).
       ...
       gitcvs.usecrlfattr
           ...
           _-_k modes to use. If the attributes force Git to treat a file as text, the _-_k mode will be left
           blank so CVS clients will treat it as text. If they suppress text conversion, the file will be set
           with _-_k_b mode, which suppresses any newline munging the client might otherwise do. If the
           attributes do not allow the file type to be determined, then _g_i_t_c_v_s_._a_l_l_b_i_n_a_r_y is used. See
           ggiittaattttrriibbuutteess(5).

       gitcvs.allbinary
           This is used if _g_i_t_c_v_s_._u_s_e_c_r_l_f_a_t_t_r does not resolve the correct _-_k_b mode to use. If true, all
           unresolved files are sent to the client in mode _-_k_b. This causes the client to treat them as binary
       ...
       gitcvs.dbname
           ...
           exact meaning depends on the used database driver, for SQLite (which is the default driver) this is
           a filename. Supports variable substitution (see ggiitt--ccvvsssseerrvveerr(1) for details). May not contain
       ...
       gitcvs.dbdriver
           ...
           git-cvsserver is tested with _D_B_D_:_:_S_Q_L_i_t_e, reported to work with _D_B_D_:_:_P_g, and reported nnoott to work
           with _D_B_D_:_:_m_y_s_q_l. Experimental feature. May not contain double colons (:). Default: _S_Q_L_i_t_e. See ggiitt--
       ...
       gitcvs.dbuser, gitcvs.dbpass
           ...
           database users and/or passwords.  _g_i_t_c_v_s_._d_b_u_s_e_r supports variable substitution (see ggiitt--
       ...
       gitcvs.dbTableNamePrefix
           ...
           database to be used for several repositories. Supports variable substitution (see ggiitt--ccvvsssseerrvveerr(1)
       ...
       _g_i_t_c_v_s_._<_a_c_c_e_s_s___m_e_t_h_o_d_>_._<_v_a_r_n_a_m_e_> (where _a_c_c_e_s_s___m_e_t_h_o_d is one of "ext" and "pserver") to make them apply
       ...
       grep.patternType
           ...
           _-_-_b_a_s_i_c_-_r_e_g_e_x_p, _-_-_e_x_t_e_n_d_e_d_-_r_e_g_e_x_p, _-_-_f_i_x_e_d_-_s_t_r_i_n_g_s, or _-_-_p_e_r_l_-_r_e_g_e_x_p option accordingly, while the
           value _d_e_f_a_u_l_t will return to the default matching behavior.
       ...
       gpg.program
           ...
           signature, "gpg --verify $file - <$signature" is run, and the program is expected to signal a good
           signature by exiting with code 0, and to generate an ascii-armored detached signature, the standard
           input of "gpg -bsau $key" is fed with the contents to be signed, and the program is expected to
       ...
       gui.diffcontext
           Specifies how many context lines should be used in calls to diff made by the ggiitt--gguuii(1). The
           default is "5".
       ...
       gui.encoding
           Specifies the default encoding to use for displaying of file contents in ggiitt--gguuii(1) and ggiittkk(1). It
           can be overridden by setting the _e_n_c_o_d_i_n_g attribute for relevant files (see ggiittaattttrriibbuutteess(5)). If
       ...
       gui.pruneduringfetch
           "true" if ggiitt--gguuii(1) should prune remote-tracking branches when performing a fetch. The default
           value is "false".

       gui.trustmtime
           Determines if ggiitt--gguuii(1) should trust the file modification timestamp or not. By default the
           timestamps are not trusted.

       gui.spellingdictionary
           Specifies the dictionary used for spell checking commit messages in the ggiitt--gguuii(1). When set to
       ...
       gui.copyblamethreshold
           Specifies the threshold to use in _g_i_t _g_u_i _b_l_a_m_e original location detection, measured in
           alphanumeric characters. See the ggiitt--bbllaammee(1) manual for more information on copy detection.

       gui.blamehistoryctx
           Specifies the radius of history context in days to show in ggiittkk(1) for the selected commit, when
           the Show History Context menu item is invoked from _g_i_t _g_u_i _b_l_a_m_e. If this variable is set to zero,
           the whole history is shown.

       guitool.<name>.cmd
           Specifies the shell command line to execute when the corresponding item of the ggiitt--gguuii(1)Tools menu
           is invoked. This option is mandatory for every tool. The command is executed from the root of the
           working directory, and in the environment it receives the name of the tool as _G_I_T___G_U_I_T_O_O_L, the name
           of the currently selected file as _F_I_L_E_N_A_M_E, and the name of the current branch as _C_U_R___B_R_A_N_C_H (if
       ...
       guitool.<name>.argprompt
           Request a string argument from the user, and pass it to the tool through the _A_R_G_S environment
           variable. Since requesting an argument implies confirmation, the _c_o_n_f_i_r_m option has no effect if
           this is enabled. If the option is set to _t_r_u_e, _y_e_s, or _1, the dialog uses a built-in generic
           prompt; otherwise the exact value of the variable is used.

       guitool.<name>.revprompt
           Request a single valid revision from the user, and set the _R_E_V_I_S_I_O_N environment variable. In other
           aspects this option is similar to _a_r_g_p_r_o_m_p_t, and can be used together with it.

       guitool.<name>.revunmerged
           Show only unmerged branches in the _r_e_v_p_r_o_m_p_t subdialog. This is useful for tools similar to merge
       ...
       guitool.<name>.prompt
           ...
           _a_r_g_p_r_o_m_p_t and _r_e_v_p_r_o_m_p_t. The default value includes the actual command.

       help.browser
           Specify the browser that will be used to display help in the _w_e_b format. See ggiitt--hheellpp(1).

       help.format
           Override the default help format used by ggiitt--hheellpp(1). Values _m_a_n, _i_n_f_o, _w_e_b and _h_t_m_l are supported.
           _m_a_n is the default.  _w_e_b and _h_t_m_l are the same.

       help.autocorrect
           Automatically correct and execute mistyped commands after waiting for the given number of
           deciseconds (0.1 sec). If more than one command can be deduced from the entered text, nothing will
           be executed. If the value of this option is negative, the corrected command will be executed
       ...
       help.htmlpath
           ...
           HTML pages will be prefixed with this path when help is displayed in the _w_e_b format. This defaults
           to the documentation path of your Git installation.

       http.proxy
           Override the HTTP proxy, normally configured using the _h_t_t_p___p_r_o_x_y, _h_t_t_p_s___p_r_o_x_y, and _a_l_l___p_r_o_x_y
       ...
       http.cookiefile
           ...
           headers or the Netscape/Mozilla cookie file format (see ccuurrll(1)). NOTE that the file specified with
       ...
       http.sslCAInfo
           ...
           be overridden by the _G_I_T___S_S_L___C_A_I_N_F_O environment variable.

       http.sslCAPath
           Path containing files with the CA certificates to verify the peer with when fetching or pushing
           over HTTPS. Can be overridden by the _G_I_T___S_S_L___C_A_P_A_T_H environment variable.
       ...
       http.maxRequests
           How many HTTP requests to launch in parallel. Can be overridden by the _G_I_T___H_T_T_P___M_A_X___R_E_Q_U_E_S_T_S
       ...
       http.lowSpeedLimit, http.lowSpeedTime
           If the HTTP transfer speed is less than _h_t_t_p_._l_o_w_S_p_e_e_d_L_i_m_i_t for longer than _h_t_t_p_._l_o_w_S_p_e_e_d_T_i_m_e
           seconds, the transfer is aborted. Can be overridden by the _G_I_T___H_T_T_P___L_O_W___S_P_E_E_D___L_I_M_I_T and
       ...
       http.noEPSV
           ...
           servers which don’t support EPSV mode. Can be overridden by the _G_I_T___C_U_R_L___F_T_P___N_O___E_P_S_V environment
       ...
       http.useragent
           ...
           value such as Mozilla/4.0. This may be necessary, for instance, if connecting through a firewall
           that restricts HTTP connections to a set of common USER_AGENT strings (but not including those like
           git/1.7.1). Can be overridden by the _G_I_T___H_T_T_P___U_S_E_R___A_G_E_N_T environment variable.
       ...
       http.<url>.*
           ...
           a URL, each element of the config key is compared to that of the URL, in the following order:
            ...
            5. User name (e.g., user in https://user@example.com/repo.git). If the config key has a user name
               it must match the user name in the URL exactly. If the config key does not have a user name,
           ...
           https://user@example.com/foo/bar a config key match of https://example.com/foo will be preferred
           over a config key match of https://user@example.com.
           ...
           differently will match properly. Environment variable settings always override any matches. The
           urls that are matched against are those given directly to Git commands. This means any URLs visited
       ...
       i18n.commitEncoding
           ...
           browser (and possibly at other places in the future or in other porcelains). See e.g.  ggiitt--
       ...
       instaweb.browser
           Specify the program that will be used to browse your working repository in gitweb. See ggiitt--
       ...
       instaweb.modulepath
           The default module path for ggiitt--iinnssttaawweebb(1) to use instead of /usr/lib/apache2/modules. Only used
           if httpd is Apache.
       ...
       interactive.singlekey
           ...
           without hitting enter). Currently this is used by the --patch mode of ggiitt--aadddd(1), ggiitt--cchheecckkoouutt(1),
           ggiitt--ccoommmmiitt(1), ggiitt--rreesseett(1), and ggiitt--ssttaasshh(1). Note that this setting is silently ignored if
           portable keystroke input is not available; requires the Perl module Term::ReadKey.

       log.abbrevCommit
           If true, makes ggiitt--lloogg(1), ggiitt--sshhooww(1), and ggiitt--wwhhaattcchhaannggeedd(1) assume --abbrev-commit. You may
           override this option with --no-abbrev-commit.

       log.date
           Set the default date-time mode for the _l_o_g command. Setting a value for log.date is similar to
           using _g_i_t _l_o_g's --date option. Possible values are relative, local, default, iso, rfc, and short;
           see ggiitt--lloogg(1) for details.

       log.decorate
           Print out the ref names of any commits that are shown by the log command. If _s_h_o_r_t is specified,
           the ref name prefixes _r_e_f_s_/_h_e_a_d_s_/, _r_e_f_s_/_t_a_g_s_/ and _r_e_f_s_/_r_e_m_o_t_e_s_/ will not be printed. If _f_u_l_l is
           specified, the full ref name (including prefix) will be printed. This is the same as the log
           commands _-_-_d_e_c_o_r_a_t_e option.

       log.showroot
           If true, the initial commit will be shown as a big creation event. This is equivalent to a diff
           against an empty tree. Tools like ggiitt--lloogg(1) or ggiitt--wwhhaattcchhaannggeedd(1), which normally hide the root
       ...
       mailmap.file
           ...
           See ggiitt--sshhoorrttlloogg(1) and ggiitt--bbllaammee(1).
       ...
       man.<tool>.cmd
           ...
           with the man page passed as argument. (See ggiitt--hheellpp(1).)

       man.<tool>.path
           Override the path for the given tool that may be used to display help in the _m_a_n format. See ggiitt--
           hheellpp(1).
       ...
       merge.renormalize
           ...
           branches with differing checkin/checkout attributes" in ggiittaattttrriibbuutteess(5).
       ...
       merge.tool
           Controls which merge tool is used by ggiitt--mmeerrggeettooooll(1). The list below shows the valid built-in
       ...
       merge.verbosity
           ...
           2. Can be overridden by the _G_I_T___M_E_R_G_E___V_E_R_B_O_S_I_T_Y environment variable.

       merge.<driver>.name
           Defines a human-readable name for a custom low-level merge driver. See ggiittaattttrriibbuutteess(5) for
           details.

       merge.<driver>.driver
           Defines the command that implements a custom low-level merge driver. See ggiittaattttrriibbuutteess(5) for
           details.
       ...
       mergetool.<tool>.cmd
           ...
           with the following variables available: _B_A_S_E is the name of a temporary file containing the common
           base of the files to be merged, if available; _L_O_C_A_L is the name of a temporary file containing the
           contents of the file on the current branch; _R_E_M_O_T_E is the name of a temporary file containing the
           contents of the file from the branch being merged; _M_E_R_G_E_D contains the name of the file to which
       ...
       mergetool.keepBackup
           ...
           .orig extension. If this variable is set to false then this file is not preserved. Defaults to true
       ...
       notes.rewriteMode
           ...
           do if the target commit already has a note. Must be one of overwrite, concatenate, or ignore.
       ...
       pack.window
           The size of the window used by ggiitt--ppaacckk--oobbjjeeccttss(1) when no window size is given on the command
           line. Defaults to 10.

       pack.depth
           The maximum delta depth used by ggiitt--ppaacckk--oobbjjeeccttss(1) when no maximum depth is given on the command
           line. Defaults to 50.

       pack.windowMemory
           The window memory size limit used by ggiitt--ppaacckk--oobbjjeeccttss(1) when no limit is given on the command
       ...
       pack.compression
           ...
           You can force recompression by passing the -F option to ggiitt--rreeppaacckk(1).

       pack.deltaCacheSize
           The maximum memory in bytes used for caching deltas in ggiitt--ppaacckk--oobbjjeeccttss(1) before writing them out
       ...
       pack.deltaCacheLimit
           The maximum size of a delta, that is cached in ggiitt--ppaacckk--oobbjjeeccttss(1). This cache is used to speed up
       ...
       pack.threads
           ...
           ggiitt--ppaacckk--oobbjjeeccttss(1) be compiled with pthreads otherwise this option is ignored with a warning. This
       ...
       pack.indexVersion
           ...
           If you have an old Git that does not understand the version 2 *.idx file, cloning or fetching over
           a non native protocol (e.g. "http" and "rsync") that will copy both *.pack file and corresponding
           *.idx file from the other side may give you a repository that cannot be accessed with your older
           version of Git. If the *.pack file is smaller than 2 GB, however, you can use ggiitt--iinnddeexx--ppaacckk(1) on
           the *.pack file to regenerate the *.idx file.

       pack.packSizeLimit
           The maximum size of a pack. This setting only affects packing to a file when repacking, i.e. the
           git:// protocol is unaffected. It can be overridden by the --max-pack-size option of ggiitt--rreeppaacckk(1).
           The minimum size allowed is limited to 1 MiB. The default is unlimited. Common unit suffixes of _k,
       ...
       pager.<cmd>
           ...
           by the value of pager.<cmd>. If --paginate or --no-pager is specified on the command line, it takes
           precedence over this option. To disable pagination for all commands, set core.pager or GIT_PAGER to
           cat.

       pretty.<name>
           Alias for a --pretty= format string, as specified in ggiitt--lloogg(1). Any aliases defined here can be
           used just as the built-in pretty formats could. For example, running git config pretty.changelog
           "format:* %H %s" would cause the invocation git log --pretty=changelog to be equivalent to running
           git log "--pretty=format:* %H %s". Note that an alias with the same name as a built-in format will
           be silently ignored.
       ...
       push.default
           ...
           ·   matching - push all branches having the same name on both ends. This makes the repository you
               are pushing to remember the set of branches that will be pushed out (e.g. if you always push
               _m_a_i_n_t and _m_a_s_t_e_r there and no other branches, the repository you push to will have these two
               branches, and your local _m_a_i_n_t and _m_a_s_t_e_r will be pushed there).

               To use this mode effectively, you have to make sure _a_l_l the branches you would push out are
               ready to be pushed out before running _g_i_t _p_u_s_h, as the whole point of this mode is to allow you
       ...
       receive.fsckObjects
           ...
           of a malformed object or a broken link. The result of an abort are only dangling objects. Defaults
       ...
       receive.hiderefs
           ...
           listed on the value of this variable is excluded, and is hidden when responding to git push, and an
       ...
       remote.<name>.skipDefaultUpdate
           If true, this remote will be skipped by default when updating using ggiitt--ffeettcchh(1) or the update
       ...
       remote.<name>.receivepack
           The default program to execute on the remote side when pushing. See option --receive-pack of ggiitt--
           ppuusshh(1).

       remote.<name>.uploadpack
           The default program to execute on the remote side when fetching. See option --upload-pack of ggiitt--
       ...
       remote.<name>.tagopt
           ...
           remote branch heads. Passing these flags directly to ggiitt--ffeettcchh(1) can override this setting. See
       ...
       repack.usedeltabaseoffset
           By default, ggiitt--rreeppaacckk(1) creates packs that use delta-base offset. If you need to share your
       ...
       repack.packKeptObjects
           If set to true, makes git repack act as if --pack-kept-objects was passed. See ggiitt--rreeppaacckk(1) for
       ...
       rerere.enabled
           ...
           automatically, should they be encountered again. By default, ggiitt--rreerreerree(1) is enabled if there is
       ...
       sendemail.identity
           ...
           precedence over values in the _s_e_n_d_e_m_a_i_l section. The default identit